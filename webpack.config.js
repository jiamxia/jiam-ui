...
module.exports = ({
  ...
  output: {
    ...
    filename: devMode ? LIBRARY_NAME+'.js' : LIBRARY_NAME+'.min.js',
  ...
  plugins: [
    ...
    new webpack.BannerPlugin(`${LIBRARY_NAME} ${pkg.version}`),
    // 将CSS提取到单独的文件中; 会对样式进行抽离压缩，然后分离输出JS脚本和CSS脚本
    new MiniCssExtractPlugin({
      // Options similar to the same options in webpackOptions.output
      // both options are optional
      filename: devMode ? LIBRARY_NAME+'.css' : LIBRARY_NAME+'.min.css',
